...
function MemoryTimelineIntro(){
  ...
  return (
    <AbsoluteFill
      style={{
        opacity:exitOpacity,
        background:"radial-gradient(circle at 50% 42%,rgba(255,75,125,0.22),transparent 31%), linear-gradient(135deg,#0a081c,#191848)",
        color:"white",
        alignItems:"center",
...
function LoginIntroMotion(){
  return (
    <div className="login-intro-overlay" role="status" aria-live="polite">
      <Player
